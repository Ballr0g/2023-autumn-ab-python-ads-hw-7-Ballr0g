...
@pytest.fixture(scope="module")
def postgres_test_session(postgres_version: str) -> sessionmaker[Session]:
    with FixedPostgresContainer(postgres_version) as pg_container:
        pg_engine = create_engine(pg_container.get_connection_url())
